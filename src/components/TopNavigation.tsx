...
export default function TopNavigation() {
  ...
  useEffect(() => {
    ...
    const handleBootComplete = () => setShowNav(true);
    ...
    return () => {
      ...
      window.removeEventListener("audio-state-change", handleAudioState);
    };
  }, []);
    ...
    <>
      <div className="fixed top-0 left-0 w-full z-50 flex flex-col pointer-events-none">
        <motion.header 
          ...
          className="w-full bg-[#1A1A1A]/95 backdrop-blur-md border-b border-[#E50914]/30 px-6 py-3 flex justify-between items-center font-mono shadow-[0_4px_20px_rgba(0,0,0,0.5)] relative pointer-events-auto"
        >
